...
Credits and many thanks to `@supperted825 <https://github.com/supperted825>`_ for the `idea and initial implementation <https://github.com/eleurent/highway-env/issues/231>`_.
